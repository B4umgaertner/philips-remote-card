...
Philips TV remote card for home assistant. Based on [this repository](https://github.com/abualy/philips-tv-remote-card). Fixed small errors/old commands to work with my tv and updated the default design to the new remote style.
